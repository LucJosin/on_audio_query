...
fun checkWithFiltersType(sortType: Int): Uri {
    return when (sortType) {
        ...
        else -> throw Exception("[checkWithFiltersType] value doesn't exist!")
    }
}
...
fun checkSongsArgs(args: Int): String {
    return when (args) {
        ...
        else -> throw Exception("[checkSongsArgs] value doesn't exist!")
    }
}
...
fun checkAlbumsArgs(args: Int): String {
    return when (args) {
        ...
        else -> throw Exception("[checkAlbumsArgs] value doesn't exist!")
    }
}
...
fun checkPlaylistsArgs(args: Int): String {
    return when (args) {
        ...
        else -> throw Exception("[checkPlaylistsArgs] value doesn't exist!")
    }
}
...
fun checkArtistsArgs(args: Int): String {
    return when (args) {
        ...
        else -> throw Exception("[checkArtistsArgs] value doesn't exist!")
    }
}
...
fun checkGenresArgs(args: Int): String {
    return when (args) {
        ...
        else -> throw Exception("[checkGenresArgs] value doesn't exist!")
    }
}
